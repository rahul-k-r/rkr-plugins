...
> **Artifact Rendering**: Under Antigravity, render `internal/run-stats/template.html` filled with data and save it as an artifact in the session artifact directory (`<artifactDirectoryPath>/stats.html` or `.md`) for user viewing.
