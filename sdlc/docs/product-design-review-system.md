...
sdlc/
  ...
  agents/{surveyor,cartographer,flow-tracer,moderator,verifier,publisher}.md
  agents/panelist.md                        extended with the product-level lens set
  skills/product-design-review/SKILL.md                 schemas, severity rubric, archetype defaults
  skills/product-design-review/session-protocol.md      the human-session script (binding)
  skills/product-design-review/report-template.md       audit report structure
