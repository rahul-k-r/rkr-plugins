...
argument-hint: "[<KEY>] [--base <branch>] [--worktree <path> | --no-worktree] [--effort <tier>] [--max-retries N] [--max-replans N] [--gate <phase,...>] [--no-gate <phase,...>] [--bypass] [--review] [--incognito] [--plain] [--show-stats] [--resume]"
---
...
```
/sdlc:story-run [<KEY>] [--base <branch>] [--worktree <path> | --no-worktree] [--effort <tier>] [--max-retries N] [--max-replans N] [--gate <phase,...>] [--no-gate <phase,...>] [--bypass] [--review] [--incognito] [--plain] [--show-stats] [--resume]
```
